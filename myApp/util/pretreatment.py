...
#                 if check_lead_foot:
#                     cv2.putText(img, "Lead foot : left", (350, 50),
#                                 cv2.FONT_HERSHEY_PLAIN, 2, (255, 255, 255), 6)
#                     lead_foot_l +=1
#                 else:
#                     cv2.putText(img, "Lead foot : right", (350, 50),
#                                 cv2.FONT_HERSHEY_PLAIN, 2, (255, 255, 255), 6)
#                     lead_foot_r =+1
...
def get_latest_video():
    return Video.objects.last()

async def videoFeed():
    videoObj = await get_latest_video()
    path = BASE_DIR + videoObj.video.url
    ...
    while True:
        try:
            ...
            if len(new_lmList) != 0:
                ...
                cv2.line(img, (lx1, ly1), (lx2, ly2), (255, 255, 255), 3)
                cv2.line(img, (lx3, ly3), (lx2, ly2), (255, 255, 255), 3)
                cv2.circle(img, (lx1, ly1), 10, (0, 0, 255), cv2.FILLED)
                cv2.circle(img, (lx1, ly1), 15, (0, 0, 255), 2)
                cv2.circle(img, (lx2, ly2), 10, (0, 0, 255), cv2.FILLED)
                cv2.circle(img, (lx2, ly2), 15, (0, 0, 255), 2)
                cv2.circle(img, (lx3, ly3), 10, (0, 0, 255), cv2.FILLED)
                cv2.circle(img, (lx3, ly3), 15, (0, 0, 255), 2)
                cv2.putText(img, str(int(left_angle)), (lx2 + 50, ly2 + 50),
                            cv2.FONT_HERSHEY_PLAIN, 2, (0, 0, 255), 2)
            else:
                no_neck_frame += 1
            ...
            await asyncio.sleep(0.04)  # Control the frame rate
